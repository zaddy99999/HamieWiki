...
export default function XPCardPage() {
  ...
  return (
    <ErrorBoundary>
      ...
      `}</style>
      <WikiNavbar currentPage="xp-card" />
      <main className="container" style={{ paddingTop: '80px' }}>
        {/* Page Header */}
        <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
          <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#2edb84', margin: '0 0 0.5rem 0' }}>XP Card Generator</h1>
          <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem', margin: 0 }}>Create your custom Abstract ID or XP card</p>
        </div>
